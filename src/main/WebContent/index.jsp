    ...
    <section>
      <div id="container">
        ...
        <div class="searchContainer">
          <img id="searchIcon" src="img/iconSearch.png" alt="" onclick="ricerca()">
          <button id="searchBtn">
            <img id="searchIconBtn" src="img/iconSearch.png" alt="" isOpenSearchbar>
          </button>
        ...
        <div id="toggle">
          ...
          <div class="cartContainer" isOpenSidebar>
            <div class="position">
              <img class="icon" src="img/iconWallet.png" alt="">
  ...
  <div class="searchbar" hidden>
    ...
    <div class="searchbarContent">
      <div class="searchbarBody">
        ...
        <button class="btn" id="close"><img class="icon" src="img/iconX.png" alt=""></button>
      </div>
      <button class="btn" ><img class="icon" src="img/iconSearch.png" alt=""></button>
    </div>
  </div>
